                        ...
                        <tbody>
                            <tr>
                                    <form action="../controlador/agregarEmpleado.php" method="POST">
                                        ...
                                        <td><input class="form-control" type="number" name="edad"></td>
                                        <td><input class="form-control" type="number" name="salario"></td>
                                        <td><input class="form-control" type="number" name="comision"></td>
                                        <td><input class="form-control" type="number" name="codigoDepartamento"></td>
